...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ENCODER_BB_CH1_Pin|ENCODER_BB_CH2_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ENCODER_BA_CH1_Pin|ENCODER_BA_CH2_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, ENCODER_FB_CH1_Pin|ENCODER_FB_CH2_Pin);
  ...
  /* USER CODE END TIM20_MspDeInit 0 */
    ...
    PB2     ------> TIM20_CH1
    */
    HAL_GPIO_DeInit(ENCODER_FA_CH2_GPIO_Port, ENCODER_FA_CH2_Pin);

    HAL_GPIO_DeInit(ENCODER_FA_CH1_GPIO_Port, ENCODER_FA_CH1_Pin);
