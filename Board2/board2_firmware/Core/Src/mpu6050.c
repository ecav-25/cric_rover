...
#define MPU6050_I2C_TIMEOUT_MS   100u 	//da capire se va bene

/* Config corrente: parte dai default e può essere cambiata via setter */
static const mpu6050_config_t mpu6050_cfg_dflt = {
    .dlpf_cfg    = MPU6050_DEFAULT_DLPF_CFG,
    .smplrt_div  = DEFAULT_SMPLRT_DIV,
