...
typedef struct {
  ...
  uint8_T is_active_Board_actions;     /* '<Root>/Board2' */
 ...
 *
 * hilite_system('diagram_acitions_sequencial/Board2')    - opens subsystem diagram_acitions_sequencial/Board2
 * hilite_system('diagram_acitions_sequencial/Board2/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'diagram_acitions_sequencial'
 * '<S1>'   : 'diagram_acitions_sequencial/Board2'
 */
...
#define Board2_IN_Normal_p             ((uint8_T)3U)
